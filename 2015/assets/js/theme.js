...
var theme = function () {
    ...
    $(document).ready(function() {
        if(!$(".style-switcher").length) {
            ...
            var color = 'red-2'; //  black, blue, green, grey, lime, orange, pink, purple, red, river, yellow
    ...
    // ---------------------------------------------------------------------------------------
    // adopt testimonials owl carousel to design
    function rptavernFix() {
        var count = $('#rptavern').find('.owl-pagination .owl-page').length;
        count = (count / 2) - 1;
        $('#rptavern').find('.owl-pagination .owl-page').eq(Math.ceil(count)).addClass('nth');
        if (count < Math.ceil(count)) {
            $('#rptavern').find('.owl-pagination').addClass('odd');
        }
    }
    $(window).load(function(){ rptavernFix() });
    $(window).resize(function(){ rptavernFix() });
    ...
    return {
        ...
        initIsotope: function () {
            ...
            function addMarker5() {
                $container5.addClass('vline');
                $container5.find('.item').each(function () {
            ...
            $(window).resize(function () {
                ...
                $container5.isotope('reLayout', function(){addMarker5();});
                $.waypoints('refresh');
            });
            $(window).load(function () {
                // initialize isotope
                ...
                $container4.isotope('reLayout', function(){addMarker4();});
                $container5.isotope({itemSelector: '.item', animationEngine: 'css'});
                $container5.isotope('reLayout', function(){addMarker5();});
            });
        ...
        // Testimonials
        initRptavern: function () {
            $("#rptavern").owlCarousel({
                //mouseDrag: false,
                items: 1,
                itemsDesktop: false,
                itemsDesktopSmall: [991, 1],
