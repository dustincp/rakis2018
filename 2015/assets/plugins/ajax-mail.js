...
$(function () {
    ...
    $("#submit_btn_rf").click(function () {
        ...
        var amtgardname = $("#af-form-rf input#name-a-rf").val();
        if (amtgardname == "" || amtgardname == "Amtgard Name *") {
            $("#af-form-rf label#name_a_error_rf").show();
            $("#af-form-rf input#name-a-rf").focus();
            return false;
        }
        var kingdom = $("#af-form-rf input#kingdom-rf").val();
        if (kingdom == "" || kingdom == "Kingdom *") {
            $("#af-form-rf label#kingdom_error_rf").show();
            $("#af-form-rf input#kingdom-rf").focus();
            return false;
        }
        var name = $("#af-form-rf input#name-rf").val();
        if (name == "" || name == "Mundane Name *") {
